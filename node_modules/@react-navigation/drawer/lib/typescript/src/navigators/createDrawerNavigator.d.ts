...
declare function DrawerNavigator({ initialRouteName, defaultStatus: customDefaultStatus, backBehavior, children, screenListeners, screenOptions, openByDefault, lazy, drawerContentOptions, ...rest }: Props): JSX.Element;
